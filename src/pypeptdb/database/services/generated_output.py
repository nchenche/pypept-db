...
def save_structure_metadata(sequence_biln: str, smiles: str, pdb: str, sdf: str, pdf_filename: str, pdb_filename: str, zip_filename: str, user_id: str=None, note: str=None) -> str:
    ...
    Args:
        ...
        pdf_filename (str): PDF report filename
